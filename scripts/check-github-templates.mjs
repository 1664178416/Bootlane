...
assertIncludes(files.pullRequest, "refreshed audit outcome closeout records were reviewed before closure, continuation, review resume, parking, deferral, supersede, or escalation", "PR template should mention queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review cadence evidence");
...
for (const entry of accuracySeedFixtureImplementationQueuedPrFollowUpReviewOutcomeRecordAuditOutcomeRecordCloseoutRecordRefreshReviewOutcomeRecordAuditOutcomeRecordCloseoutRecordRefreshReviewOutcomeRecordAuditOutcomeRecordCloseoutRecordRefreshReviewCadence) {
  ...
  assertIncludes(files.roadmap, entry.review, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review ${entry.review}`);
  assertIncludes(files.roadmap, entry.refreshRule, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review rule ${entry.review}`);
  assertIncludes(files.roadmap, entry.cadence, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review cadence ${entry.review}`);
  assertIncludes(files.roadmap, entry.requiredInputs, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review inputs ${entry.review}`);
  assertIncludes(files.roadmap, entry.staleWhen, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review stale condition ${entry.review}`);
  assertIncludes(files.roadmap, entry.routeTo, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review route ${entry.review}`);
  assertIncludes(files.roadmap, entry.maintainerAction, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review action ${entry.review}`);
  assertIncludes(files.roadmap, entry.record, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review record ${entry.review}`);
}
...
for (const entry of accuracySeedFixtureImplementationQueuedPrFollowUpReviewOutcomeRecordAuditOutcomeRecordCloseoutRecordRefreshReviewOutcomeRecordAuditOutcomeRecordCloseoutRecordRefreshReviewOutcomeRecordAuditOutcomeRecordCloseoutRecordRefreshReviewOutcomeRouting) {
  ...
  assertIncludes(files.roadmap, entry.outcome, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome ${entry.outcome}`);
  assertIncludes(files.roadmap, entry.reviewScope, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review scope ${entry.outcome}`);
  assertIncludes(files.roadmap, entry.appliesWhen, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review applies-when ${entry.outcome}`);
  assertIncludes(files.roadmap, entry.requiredEvidence, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review evidence ${entry.outcome}`);
  assertIncludes(files.roadmap, entry.routeTo, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review route ${entry.outcome}`);
  assertIncludes(files.roadmap, entry.maintainerAction, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review action ${entry.outcome}`);
  assertIncludes(files.roadmap, entry.record, `roadmap should document queued PR follow-up review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review outcome record audit outcome record closeout record refresh review record ${entry.outcome}`);
}
