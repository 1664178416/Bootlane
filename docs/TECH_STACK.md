...
Seed Fixture Implementation Queued PR Follow-Up Review Outcome Record Audit Outcome Record Closeout Record Refresh Review Outcome Record Audit Outcome Record Closeout Record Refresh Review Outcome Record Audit Outcome Record Closeout Record Refresh Review Cadence reviews those refreshed records before closure, continuation, review resume, parking, deferral, supersede, or escalation relies on them.
Seed Fixture Implementation Queued PR Follow-Up Review Outcome Record Audit Outcome Record Closeout Record Refresh Review Outcome Record Audit Outcome Record Closeout Record Refresh Review Outcome Record Audit Outcome Record Closeout Record Refresh Review Outcome Routing routes reviewed refreshed records to accepted, refresh-again, blocked or deferred, parked, or closed/superseded outcomes before closure or continuation relies on them.
...
- Keep Seed Fixture Implementation Queued PR Follow-Up Review Outcome Record Audit Outcome Record Closeout Record Refresh Review Outcome Record Audit Outcome Record Closeout Record Refresh Review Outcome Record Audit Outcome Record Closeout Record Refresh Review Cadence in `scripts/triage-contracts.mjs` so refreshed closeout review cadence shares one source of truth with [Triage Guide](TRIAGE.md), [Roadmap](ROADMAP.md), launch docs, and template docs checks.
- Keep Seed Fixture Implementation Queued PR Follow-Up Review Outcome Record Audit Outcome Record Closeout Record Refresh Review Outcome Record Audit Outcome Record Closeout Record Refresh Review Outcome Record Audit Outcome Record Closeout Record Refresh Review Outcome Routing in `scripts/triage-contracts.mjs` so refreshed closeout review outcomes share one source of truth with [Triage Guide](TRIAGE.md), [Roadmap](ROADMAP.md), launch docs, and template docs checks.
